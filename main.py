...
l_linha = Label(frame_cima, text='', width=275, anchor=NW,font=('Ivy 10'), bg=co2, fg=co4)
    ...
    if nome == 'admin' and senha == 'admin':
        messagebox.showinfo('Login', 'Seja bem vindo Admin !!!')
         ...
         messagebox.showinfo('Login', 'Seja bem vindo de Volta ' +credenciais[0])
            ...
            # Deletar e mostrar dados do usuário
         ...
         messagebox.showwarning('Erro', 'Verifique o nome e senha se estão corretos')

# Função após validação de senha ------------------------
def nova_janela():
...
l_nome = Label(frame_baixo, text='Nome *', anchor=NW,font=('Ivy 12'), bg=co1, fg=co4)
l_nome.place(x=10, y=20)
e_nome = Entry(frame_baixo, width=25, justify='left', font=("", 15), highlightthickness=1, relief='solid')
e_nome.place(x=14, y=50)

l_pass = Label(frame_baixo, text='Senha *', anchor=NW,font=('Ivy 12'), bg=co1, fg=co4)
l_pass.place(x=10, y=95)
e_pass = Entry(frame_baixo, width=25, justify='left', show='*', font=("", 15), highlightthickness=1, relief='solid')
e_pass.place(x=14, y=130)


b_confirm = Button(frame_baixo, command=verifica_senha, text='Entrar *', width=39, height=2,font=('Ivy 9 bold'), bg=co2, fg=co1, relief=RAISED, overrelief=RIDGE)
